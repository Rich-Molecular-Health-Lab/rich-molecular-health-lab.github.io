...
pronouns <- "He/Him"
callme   <- "Thomas"
research <- "Thomas’s research uses innovative genomic methods to streamline conservation monitoring for urban bat populations. His work leverages Oxford Nanopore Adaptive Sampling for rapid and efficient detection of environmental DNA, significantly improving monitoring strategies. He also compares gut microbiomes and eDNA data to better understand how urban environments influence bat ecology, health, and conservation status."

projects <- list(
  "Streamlining bat conservation monitoring with Oxford Nanopore Adaptive Sampling",
  "Comparative analysis of gut microbiomes and environmental DNA in urban bat populations"
)
...
```{r, results='asis'}
tags$img(file = "images/richlab_2025.jpg", width = "75%", alt = "Rich lab at the 2025 UNO Student Research Symposium")
```
